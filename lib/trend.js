...
/**
 * Every label `shapeOf` can return. Calibration needs the full list,
 * not just the ones that happened to fire — a label that never fires
 * is as much a problem as one that fires on everything, and you
 * cannot see the first kind by looking at results alone.
 */
export const SHAPES = [
  "flat all week",
  "chopping sideways",
  "climbing",
  "climbing, at its weekly high",
  "up on the week, sliding back",
  "spiked and gave most of it back",
  "falling",
  "falling, at its weekly low",
  "down on the week, bouncing",
